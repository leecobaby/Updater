...
// const activityId3 = `` // 只针对淘金币1212任务
...
try {
  ...
  const url3 = `https://service-lv90ws2p-1251309300.sh.apigw.tencentcs.com/release/api?activityId=${activityId3}&tk=${tk}`
  document.write(JSON.stringify({ Cookie, url, url2, url3 }))
} catch (error) {
