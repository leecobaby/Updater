...
try {
  ...
  const url = `https://service-lv90ws2p-1251309300.sh.apigw.tencentcs.com/release/api?activityId=${activityId}&tk=${tk}&api=mtop.alibaba.svip.langrisser.query&app=ele`
