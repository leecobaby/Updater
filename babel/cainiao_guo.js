...
function takeRequest (type) {
  ...
  switch (type) {
    case 'doSimpleTaskURL':
      url = `https://service-daubfate-1251309300.gz.apigw.tencentcs.com/release/api?activityId=Cainiao_guo&tk=${$.tk}&api=mtop.cncreditmarket.task.checkfinish&guoguo=${$.taskId}`
